...
export default function Repository({ repo, description, stars }: PinnedRepo): JSX.Element {
  return (
    <Link href={'https://github.com/saliven/' + repo}>
      <a
        target="_blank"
        className="hover:bg-dark-100 hover:bg-opacity-60 relative h-auto transition-all duration-200 border border-dark-100 rounded-xl p-5 hover:cursor-pointer"
      >
